...
#### 1.1.1. Run the base driver:
    ...
    roslaunch notspot_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch notspot_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch notspot_config slam.launch rviz:=true
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch notspot_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch notspot_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
